...
class Marcas extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_marcas';
	var $table_index= 'marcasid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_marcascf', 'marcasid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_marcas', 'vtiger_marcascf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_marcas'   => 'marcasid',
	    'vtiger_marcascf' => 'marcasid');
	...
	var $list_fields = Array (
		...
		'marcasno'     => Array('marcas'   => 'marcasno'),
		'marcaname'    => Array('marcas'   => 'marcaname'),
		'puedecomprar' => Array('marcas'   => 'puedecomprar'),
		'compra'       => Array('marcas'   => 'compra'),
		'presentado'   => Array('marcas'   => 'presentado'),
		'novedades'    => Array('marcas'   => 'novedades'),
		'description'  => Array('crmentity'=> 'description'),
		'accid'        => Array('marcas'   => 'accid'),
		'ctoid'        => Array('marcas'   => 'ctoid'),
	);
	...
	var $popup_fields = Array('marcasno');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'marcasno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'marcasno';

	// Required Information for enabling Import feature
	var $required_fields = Array('marcasno'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'marcasno';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'marcasno');
	...
	function vtlib_handler($modulename, $event_type) {
		if($event_type == 'module.postinstall') {
			...
			$this->setModuleSeqNumber('configure', $modulename, 'MARCA-', '0000001');
			...
			$mod_acc->setRelatedList($module, 'Marcas', Array('ADD'),'get_dependents_list');
